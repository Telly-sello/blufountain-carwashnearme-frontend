...
const Bookings = () => {
  ...
  return (
    <>
      <div className="  ">
        <div className="flex justify-end ml-10 mt-16 mb-4">
          <button onClick={(signIn) => auth.signOut()}>
            <div className="font-medium cursor-pointer text-center tracking-wide py-2 mr-4 text-xs sm:px-2 w-24 border border-blue-500 text-blue-500 bg-white-500 outline-none  rounded-lg capitalize hover:bg-sky-500 hover:text-white-500 transition-all hover:shadow-blue ">
              Sign out
            </div>
          </button>
        </div>
{/* <div className="mb-5  shadow-sm p-5 text-blue-300  w-full">
          <p> Welcome </p>{" "}
          <span className="pl-1 text-sky-500"> {user.displayName} </span>
        </div> */}
      </div>
      <div className="ml-24 w-3/4 text-sm">
        {/* <Header/> */}
        <>
{cancelBooking && (
 <>
       ...
       <div style={{ display: "flex", justifyContent: "end" }}>
         ...
         >
           Confirm
            ...
            <div
              className=" flex justify-center text-xl w-screen"
              
            >
              <div className="h-screen">
                <div
                  style={{ marginBottom: "50px" }}
                  className="font-bold flex justify-center text-4xl"
                >
                  Bookings
                </div>
                <div class="flex flex-wrap -mx-3 mb-2 mr-2">
                  <div className="relative w-full  justify-end flex ">
                    <select
                      class="w-1/5 h-8  border-2 border-sky-500 mb-5  rounded "
                      id="grid-reason"
                      name="reason"
                    ...
                    <input
                      ...
                      type="search"
                      placeholder="Search"
                      class="w-1/5 h-8  border-2 border-sky-500 mb-5  rounded ml-2  "
                      value={inputValue}
